...
training_iters = 2000000   #训练的循环次数1000000 7801 12400 就到1了
                           #500万 39001
batch_size = 120          #随机梯度下降时，每次选择batch的大小
...
import pandas as pd
df=pd.read_csv('samples_embedding128_default.csv')
print('before shuffle',len(df))
df=df.sample(frac=1) #来了之后直接shuffle
